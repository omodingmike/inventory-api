<?php
    ...
    class Utils
    {
         ...
         * @throws Exception
         */
        static function validatePartnerParams ( $partner_params )
        {
         ...
         * @throws Exception
         */
        static function validateIdParams ( $id_params , $job_type )
        {
            if ( $id_params == null ) {
                throw new Exception( "Please ensure that you send through partner params" );
            }

            $not_doc_or_biz_verification = !in_array( $job_type , [ JobType::DOCUMENT_VERIFICATION , JobType::BUSINESS_VERIFICATION ] );
         ...
         * @throws Exception
         */
        static function validateImageParams ( $image_details , $job_type , $use_enrolled_image )
        {
        ...
        static function validateOptions ( $options )
        {
            ...
            if ( !strlen( self ::array_value_by_key( "optional_callback" , $options ) ) && !self ::array_value_by_key( "return_job_status" , $options ) ) {
                throw new Exception( "Please choose to either get your response via the callback or job status query" );
            }
        }

        static function array_value_by_key ( $key , $array )
        {
         ...
         * @throws Exception
         */
        static function validateJobTypes ( array $expected_types , int $job_type )
        {
