...
//    } );
    ...
    class IdApi
    {
         ...
         * @throws Exception
         */
        public function submit_job ( array $partner_params , array $id_info , array $options ) : array
        {
            ...
            Utils ::validateJobTypes( [ JobType::ENHANCED_KYC ] , $job_type );

            $user_async       = Utils ::array_value_by_key( "user_async" , $options );
